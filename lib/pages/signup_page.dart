                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      TextField(
                        ...
                        obscureText:
                            !_isPasswordVisible, // Toggles visibility based on state
                        decoration: InputDecoration(
                          labelText: 'Password',
                          ...
                          suffixIcon: IconButton(
                            icon: Icon(
                              ...
                              color: Theme.of(
                                context,
                              ).primaryColorDark, // Use theme color
                            ),
                            onPressed: () {
                              setState(() {
                                _isPasswordVisible =
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            print(
                              'Attempting sign up with: Name: $name, Email: $email, Password: $password',
                            );
                            ScaffoldMessenger.of(context).showSnackBar(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color(
                              0xFF177F23,
                            ), // Button background color (adjust to your logo's green)
